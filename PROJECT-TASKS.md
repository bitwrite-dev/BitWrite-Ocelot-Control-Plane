...
| 8 | — | #312 | [Task] Snapshot Query UseCases Implementation (7) | feature/312-snapshot-query-usecases | ✅ **Done** | **High** |
...
| 3 | — | #316 | [Task] Fix PublicationRepository Stubs | feature/316-fix-publicationrepository-stubs | ✅ **Done** | **High** |
| 4 | — | #317 | [Task] Fix RuntimeInstanceRepository & PluginRepository Stubs | feature/317-fix-runtimeinstance-plugin-repository-stubs | ✅ **Done** | **High** |
...
| 1.6 | #346 | SDK Service Client | — | ✅ Done | Low |
| 1.7 | #347 | SDK Snapshot Client | — | ✅ Done | Low |
...
| 39.6 | **#346** | SDK Service Client | ✅ Done |
| 39.7 | **#347** | SDK Snapshot Client | ✅ Done |
