...
public class EnablePluginCommandHandler
{
    ...
    public async Task<PluginResponse?> HandleAsync(EnablePluginCommand command, CancellationToken cancellationToken = default)
    {
