...
public class UpgradePluginCommandHandler
{
    private readonly IPluginRepository _pluginRepository;
    private readonly IDomainEventDispatcher _eventDispatcher;

    public UpgradePluginCommandHandler(
    ...
    public async Task<PluginResponse?> HandleAsync(UpgradePluginCommand command, CancellationToken cancellationToken = default)
    {
        ...
        // Upgrade the plugin
        plugin.Upgrade(command.NewVersion);
