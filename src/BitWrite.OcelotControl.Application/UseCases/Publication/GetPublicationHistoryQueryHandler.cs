...
public class GetPublicationHistoryQueryHandler
{
    private readonly IPublicationRepository _publicationRepository;

    public GetPublicationHistoryQueryHandler(IPublicationRepository publicationRepository)
    {
        _publicationRepository = publicationRepository;
    }

    public async Task<PublicationListResponse> HandleAsync(GetPublicationHistoryQuery query, CancellationToken cancellationToken = default)
    {
